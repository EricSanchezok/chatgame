...
function Composer({
  ...
  return (
    <ComposerPrimitive.Root className="relative flex w-full flex-col">
      <div className="aui-composer-shell flex w-full cursor-text flex-col gap-2 rounded-3xl border border-border bg-card p-2 transition-[border-color,box-shadow]">
