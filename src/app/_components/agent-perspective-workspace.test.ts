...
import { buildAgentPerspectiveGraph } from "./agent-perspective-workspace";
...
describe("Agent Perspective relationship graph", () => {
  ...
  it("does not invent a meter or a relation for absent structures", () => {
    ...
    view.mechanics = { meters: [], quantities: [], ratings: [] };
    ...
    expect(view.mechanics).toEqual({ meters: [], quantities: [], ratings: [] });
