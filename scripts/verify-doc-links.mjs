...
export function slugify(heading) {
  // GitHub-style slug for CJK-capable headings: lowercase, whitespace runs to
  // hyphens, then drop punctuation/symbols but keep letters, numbers, hyphens
  // and underscores in any script (including CJK). `\p{L}\p{N}` requires the
  // `u` flag.
  return heading
    .trim()
    .toLowerCase()
