...
世界剧本使用 schema v6，SimulationState 使用 schema v8，WorldSessionDocument 使用 schema v9，ModelCatalog 使用 schema v2。旧契约直接拒绝，无迁移、默认值或双轨读取。
...
- [世界剧本格式](../game-design/script-format.md) — schema v6 Profile 与法则授权格式。
