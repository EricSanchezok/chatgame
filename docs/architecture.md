...
| 层 | 目录 | 唯一职责 |
|---|---|---|
| 世界契约 | `src/script/` | 严格读取 schema v5 YAML，规范化内容并构造带内容身份的 `WorldDefinition` 与 `SimulationState` v7 |
