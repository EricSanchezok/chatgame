...
The reference algorithm deliberately spends complete work to provide a precise semantic baseline. Candidate retrieval is an opt-in, fail-closed middleware; the default model-facing path remains FullCatalog:
